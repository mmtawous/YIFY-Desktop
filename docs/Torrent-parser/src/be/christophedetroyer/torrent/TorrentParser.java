...
public class TorrentParser {
	public static Torrent parseTorrent(InputStream input) throws IOException, ParseException {
		Reader r = new Reader(input);
		return parseTorrent(r);
	}

	public static Torrent parseTorrent(String filePath) throws IOException, ParseException {
		Reader r = new Reader(new File(filePath));
		return parseTorrent(r);
	}

	public static Torrent parseTorrent(Reader r) throws IOException, ParseException {
